  ...
  return (
    <div className='aboutMainDiv'>
        ...
        <h2 className="font-bold text-2xl ml-7 my-5">About us</h2>
            ...
            <Link to={"/"}><div className="grid justify-items-center mb-7 mt-3"><button className="btn btn-active color_second rounded-3xl text-white w-60">Explore collections</button></div></Link>
        </div>
